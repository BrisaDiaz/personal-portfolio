...
export const PROJECTS = [
  ...
  },
  {
    ...
    features: [
      ...
      "Access to api endpoints base authorization and permission.",
      "Media storage using cloudinary service.",
      "Request supported : GET, PUT, POST, DELETE.",
      "Routes: USERS , PRODUCTS, CATEGORIES, ORDERS,NEWSLETTER, CONTACT, AUTH.",
...
export const SKILLS = [
  ...
  "Experience in configuration of the dependencies and management of compatibility issues.",
